-- Capture on-demand email queue processor infrastructure.
-- Mirrors the live definitions exactly. Idempotent; no secrets in file.
...
BEGIN
  ...
  PERFORM net.http_post(
    url := 'https://iwvpbnhsabnioxrlddqx.supabase.co/functions/v1/process-email-queue',
