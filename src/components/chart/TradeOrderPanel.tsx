    ...
    <div className="w-[340px] flex-shrink-0 bg-card border-l border-border flex flex-col h-full overflow-y-auto text-foreground">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-foreground font-semibold text-sm">MESM2026</span>
        </div>
      ...
      <div className="mx-3 mt-4 space-y-2">
        ...
        <div className="flex items-center justify-between text-[12px]">
          ...
          <span className="text-foreground">{tickValue.toFixed(2)} × {units} = {totalTickValue.toFixed(2)} <span className="text-muted-foreground">USD</span></span>
        </div>
        <div className="flex items-center justify-between text-[12px]">
