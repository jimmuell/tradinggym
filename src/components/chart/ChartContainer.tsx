    ...
    <div className="relative flex-1 min-w-0 bg-white">
      ...
      <div className="absolute top-1 left-1 z-10 pointer-events-none">
        ...
        <div className="flex items-center gap-0 mt-1.5 pointer-events-auto">
          <div className="flex flex-col items-center justify-center bg-[#f23645] text-white rounded-l-[6px] min-w-[90px] py-1.5 px-3 border border-[#f23645]">
          ...
          <div className="flex flex-col items-center justify-center bg-[#2962ff] text-white rounded-r-[6px] min-w-[90px] py-1.5 px-3 border border-[#2962ff]">
