    ...
    <div className="relative flex-1 min-w-0 bg-white">
      ...
      <div className="absolute top-1 left-4 z-10 pointer-events-none">
        <div className="flex items-center gap-2 text-[14px] text-[#787b86] flex-wrap">
          <img src="https://flagcdn.com/w80/us.png" alt="US" <img src="https://flagcdn.com/w80/us.png" alt="US" className="w-6 h-6 rounded-full object-cover object-[60%_center] border border-[#d1d4dc]/30 shadow-sm" /> />
