...
export default function ChartSettingsModal({ open, onClose }: ChartSettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div
        className="bg-[#1e222d] text-[#d1d4dc] rounded-lg shadow-2xl w-[680px] max-h-[520px] flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3 border-b border-[#2a2e39]">
          <h2 className="text-[15px] font-semibold text-white">Chart settings</h2>
          <button onClick={onClose} className="text-[#787b86] hover:text-white p-1 rounded hover:bg-[#2a2e39]">
            <X size={18} />
          </button>
        </div>
        ...
        <div className="flex flex-1 min-h-0">
          {/* Tab sidebar */}
          <div className="flex flex-col w-[160px] border-r border-[#2a2e39] py-2">
            {tabs.map((tab) => (
              <button
                key={tab}
                onClick={() => setActiveTab(tab)}
                className={`text-left px-4 py-2 text-[13px] hover:bg-[#2a2e39] ${
                  activeTab === tab ? 'text-white bg-[#2a2e39] font-medium' : 'text-[#787b86]'
                }`}
              >
                {tab}
              </button>
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-[#2a2e39]">
          <button className="text-[13px] text-[#787b86] hover:text-white">Reset to defaults</button>
          <div className="flex gap-2">
            <button onClick={onClose} className="px-4 py-1.5 text-[13px] rounded bg-[#2a2e39] text-[#d1d4dc] hover:bg-[#363a45]">
              Cancel
            </button>
...
function Toggle({ defaultChecked = false }: { defaultChecked?: boolean }) {
  ...
  return (
    <button
      onClick={() => setOn(!on)}
      className={`w-9 h-5 rounded-full transition-colors ${on ? 'bg-[#2962ff]' : 'bg-[#363a45]'}`}
    >
...
function ColorSwatch({ color }: { color: string }) {
  return <div className="w-6 h-6 rounded border border-[#363a45] cursor-pointer hover:border-[#787b86]" style={{ backgroundColor: color }} />;
}

function SelectBox({ options, defaultValue }: { options: string[]; defaultValue?: string }) {
  return (
    <select className="bg-[#2a2e39] text-[#d1d4dc] text-[12px] rounded px-2 py-1 border border-[#363a45] outline-none" defaultValue={defaultValue}>
...
function AppearanceTab() {
  return (
    <div className="space-y-1">
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Candles</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Background</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Grid</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Crosshair</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Watermark</h3>
...
function SymbolTab() {
  return (
    <div className="space-y-1">
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Price line</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Previous close</h3>
      <SettingRow label="Show previous close"><Toggle /></SettingRow>

      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Session breaks</h3>
...
function StatusLineTab() {
  return (
    <div className="space-y-1">
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Values</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Indicator values</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Title</h3>
...
function ScalesTab() {
  return (
    <div className="space-y-1">
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Price scale</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Time scale</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Labels</h3>
...
function TradingTab() {
  return (
    <div className="space-y-1">
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Order panel</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Positions</h3>
      ...
      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Orders</h3>
...
function EventsTab() {
  return (
    <div className="space-y-1">
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Dividends</h3>
      <SettingRow label="Show dividends"><Toggle /></SettingRow>

      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Splits</h3>
      <SettingRow label="Show splits"><Toggle /></SettingRow>

      <div className="border-t border-[#2a2e39] my-3" />
      <h3 className="text-[13px] text-[#787b86] font-medium mb-2">Earnings</h3>
